    ...
    <div className="w-screen h-screen flex items-center justify-center bg-gray-100">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div>
                    <input type="password" placeholder="Password" value={credentials.password} onChange={(e)=>{setCredentials(prev=>({...prev,password:e.target.value})); setErrors(prev=>({...prev, password:''}))}} className="py-2 w-full px-4 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"/>
