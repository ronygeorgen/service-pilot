...
export default function WindowCleaningQuote() {
  ...
  return (
    <div className="min-h-screen bg-gray-200">
      {/* Header Section */}
      <div className="bg-white mx-4 md:mx-8 lg:mx-16 xl:mx-32 pt-8 pb-6">
        <div className="text-center">
          <div className="mb-8">
            <img src="/placeholder.svg?height=120&width=120" alt="Tru Shine Logo" className="mx-auto h-20 w-20" />
          </div>

          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-2">PREPARED FOR:</h2>
            <p className="text-lg font-medium">test test</p>
            <p className="text-gray-600">1146 South Waukegan Road ,</p>
            <p className="text-gray-600">Barker, TX 60085</p>
          </div>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-4">Which of These Services Would You Like?</h3>
      ...
      <div className="bg-white mx-4 md:mx-8 lg:mx-16 xl:mx-32 py-8">
        <h3 className="text-2xl font-semibold text-center mb-6">Window Cleaning</h3>
      ...
      <div className="bg-white mx-4 md:mx-8 lg:mx-16 xl:mx-32 py-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="flex space-x-2">
            {steps.map((step, index) => (
              <div
                key={step.id}
                className={`w-3 h-3 rounded-full ${index === 2 ? "bg-green-500" : "bg-blue-500"}`}
              ></div>
            ))}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          {plans.map((plan) => (
            <div key={plan.id} className="bg-white border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-500 text-sm mb-4">Plus Tax</div>
                  ...
                  {selectedPlan === plan.id ? (
                    ...
                    <button
                      ...
                      className="bg-blue-400 text-white py-2 px-6 rounded hover:bg-blue-500 transition-colors"
                    >
                      Select
                    </button>
                  )}
      ...
      <div className="bg-white mx-4 md:mx-8 lg:mx-16 xl:mx-32 py-8">
        <div className="text-center mb-8">
          <h3 className="text-2xl font-semibold mb-4">Learn more about us!</h3>
          <p className="text-gray-600 mb-4">
            Below is some information about our company, along with an overview of the information you provided during
            the quoting process.
          </p>
          <a href="#" className="text-blue-500 hover:underline flex items-center justify-center space-x-2">
        ...
        {activeTab === "about" && (
          <div className="flex flex-col md:flex-row items-start space-y-6 md:space-y-0 md:space-x-8">
            <div className="flex-shrink-0">
              <img src="/placeholder.svg?height=150&width=150" alt="Company Logo" className="h-32 w-32" />
            </div>
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-4">- Arman K</p>
            </div>
          </div>
        )}

        <div className="mt-12">
          <h4 className="text-xl font-semibold mb-4">Disclaimer</h4>
      ...
      <div className="bg-white mx-4 md:mx-8 lg:mx-16 xl:mx-32 py-8">
        <div className="text-center mb-8">
          ...
          <h3 className="text-xl font-semibold mb-6">You've chosen the following services:</h3>

          <div className="flex justify-between items-center py-4 border-b">
            <div className="text-left">
              <span className="text-blue-500 font-medium">WINDOW CLEANING (SEMI ANNUALLY)</span>
            </div>
            <div className="text-right">
              <span className="text-xl font-bold">${selectedPlanData?.price}</span>
        ...
        <div className="space-y-4 mb-8">
          <div className="border border-blue-300 rounded">
            <button
              ...
              className="w-full flex justify-between items-center p-4 text-blue-500 hover:bg-blue-50"
            >
              <span>LEAVE A NOTE</span>
              {expandedSections.note ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
            </button>
        ...
        {/* Signature Section */}
        <div className="mb-8">
          <h4 className="text-lg font-semibold mb-4">Please leave your signature below</h4>
          <div className="border-b-2 border-gray-300 pb-2 mb-6">
            <input
              ...
              className="w-full text-center text-lg italic focus:outline-none"
            />
          </div>
        </div>
        ...
        {/* Final Button */}
        <div className="text-center">
          <button className="bg-blue-500 text-white px-8 py-3 rounded hover:bg-blue-600 transition-colors font-medium">
      ...
      <div className="bg-green-500 text-white py-4 px-6 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <div className="bg-white text-green-500 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold">
            1
          </div>
        </div>
